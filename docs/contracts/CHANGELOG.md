...
- Governance check in CI searches for the literal text "CHANGELOG.md" within docs/contracts to ensure a contract change is accompanied by a CHANGELOG update.
